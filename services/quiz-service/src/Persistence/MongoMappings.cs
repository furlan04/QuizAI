...
namespace QuizService.Persistence;
...
public static class MongoMappings
{
    ...
    public static void Register()
    {
        ...
        MapSnakeCase<Quiz>(cm => ConfigureObjectIdStringId(cm.IdMemberMap));
        MapSnakeCase<Question>();
        MapSnakeCase<LeaderboardEntry>();

        MapSnakeCase<Session>(cm => ConfigureObjectIdStringId(cm.IdMemberMap));
        MapSnakeCase<Answer>();

        MapSnakeCase<User>();            // Id stringa così com'è (nessuna rappresentazione ObjectId)
        MapSnakeCase<UserAttempt>();
        MapSnakeCase<AttemptAnswer>();
    }
