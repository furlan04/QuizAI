/**
 * Set di icone SVG inline (stile lucide, licenza MIT) — niente dipendenze esterne.
 * Monocromatiche: il colore arriva da `currentColor`, quindi si controlla con
 * le classi `text-*` di Tailwind o con `style={{ color }}`.
 */
